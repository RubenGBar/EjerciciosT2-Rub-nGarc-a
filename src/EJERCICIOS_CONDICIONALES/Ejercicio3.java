 ...
 * Valor introducido es = 90000, 50 y 1900 | Resultado esperado: Deberias de comprar mas comida  | Resultado obtenido: Deberias de comprar mas comida  
 * Valor introducido es = 90000, 50 y 1800 | Resultado esperado: Vas justo de comida, compra algo mas por si acaso | Resultado obtenido: Vas justo de comida, compra algo mas por si acaso 
...
public class Ejercicio3 {
	public static void main(String[] args) {
		...
		if (kilosDiariosMedios > kilosComidosTotales) {
			...
			System.out.println("Deberias de comprar mas comida ");
			
		}else if (kilosDiariosMedios == kilosComidosTotales) {
			
			System.out.println("Vas justo de comida, compra algo mas por si acaso ");
